...
import org.apache.fineract.infrastructure.core.exceptionmapper.DuplicateCommandExceptionMapper;
...
public class IdempotencyTest {
    ...
    public void shouldUpdateStepOrder() {
        ...
        Assertions.assertNull(response.header(DuplicateCommandExceptionMapper.IDEMPOTENT_CACHE_HEADER));
        Assertions.assertNotNull(responseSecond.header(DuplicateCommandExceptionMapper.IDEMPOTENT_CACHE_HEADER));
        ...
        Response updateSecond = IdempotencyHelper.updateBusinessStepOrder(requestSpec, responseSpec, LOAN_JOB_NAME,
                IdempotencyHelper.toJsonString(requestBody), idempotencyKeyHeader);
        Assertions.assertNull(update.header(DuplicateCommandExceptionMapper.IDEMPOTENT_CACHE_HEADER));
        Assertions.assertNotNull(updateSecond.header(DuplicateCommandExceptionMapper.IDEMPOTENT_CACHE_HEADER));
    ...
    public void shoudTheSecondRequestWithSameIdempotencyKeyWillFailureToo() {
        ...
        Assertions.assertNull(response1.getHeader(DuplicateCommandExceptionMapper.IDEMPOTENT_CACHE_HEADER));
        ...
        Response response2 = IdempotencyHelper.updateBusinessStepOrderWithError(requestSpec, responseSpecForError, LOAN_JOB_NAME,
                IdempotencyHelper.toJsonString(requestBody), idempotencyKey);
        Assertions.assertNotNull(response2.getHeader(DuplicateCommandExceptionMapper.IDEMPOTENT_CACHE_HEADER));
