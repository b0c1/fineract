...
public final class Utils {
    ...
    public static <T> Response performServerGetRaw(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
    ...
    public static <T> Response performServerPutRaw(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
